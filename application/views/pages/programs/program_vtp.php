...
<html>
 	<head>
		<title>Programs - Voluntary Teaching Program</title>
		<meta charset="utf-8">
		<!--[if IE]><meta http-equiv='X-UA-Compatible' content='IE=edge,chrome=1'><![endif]-->
		<meta name="robots" content="index, follow" > 
		<meta name="keywords" content="Mataharikecil" > 
		<meta name="description" content="Programs - Voluntary Teaching Program" > 
        ...
        <div class="page-title-large5-cont bg-gray-dark">
          <div class="container relative">
         	  <div class="page-title-large5-text-cont">
         	  	<div>
         	  	  <h1 class="page-title5"><font color="white">Voluntary Teaching Program</font></h1>
         	  	</div>
         	  </div>
          </div>
        </div>
            ...
            <div class="post-prev-img mb-50">
              <img src="<?= base_url().'assets/'?>images/programs_vtp/header.jpg" alt="img"></a>
            </div>
            ...
            <div class="row">
              ...
              <!-- TEXT -->
                ...
                <h4 class="font-open-sans"><strong>Voluntary Teaching Program</strong></h4>
                <p>Voluntary Teaching Program merupakan sebuah program mengajar anak didik tingkat TK dan SMP secara sukarela bagi pelajar atau mahasiswa maupun pekerja yang memiliki waktu luang di Kota Bandung dan Jakarta. Program ini dilaksanakan oleh Mataharikecil Indonesia Foundation sejak tahun 2015.</p>
							</div>
            ...
            <!-- ITEMS GRID -->
              <ul class="port-grid masonry clearfix" id="items-grid">
                ...
                <li class="port-item mix design lightbox-item">
                  <a href="<?= base_url().'assets/'?>images/programs_vtp/1.jpg" class="lightbox">
                    <div class="port-img-overlay">
                      <img class="port-main-img" src="<?= base_url().'assets/'?>images/programs_vtp/1.jpg" alt="img" >
                    </div>
                ...
                <!-- Item -->
                <li class="port-item mix design lightbox-item">
                  <a href="<?= base_url().'assets/'?>images/programs_vtp/3big.jpg" class="lightbox">
                    <div class="port-img-overlay">
                      <img class="port-main-img" src="<?= base_url().'assets/'?>images/programs_vtp/3.jpg" alt="img" >
                    </div>
                    <div class="port-overlay-cont">
                      <div class="port-btn-cont">
                        <div aria-hidden="true" class="icon_search"></div>
                ...
                <!-- Item big -->
                <li class="port-item mix design lightbox-item">
                  <a href="<?= base_url().'assets/'?>images/programs_vtp/2big.jpg" class="lightbox">
                    <div class="port-img-overlay">
                      <img class="port-main-img" src="<?= base_url().'assets/'?>images/programs_vtp/2.jpg" alt="img" >
                    </div>
                    <div class="port-overlay-cont">
                      <div class="port-btn-cont">
                        <div aria-hidden="true" class="icon_search"></div>
                ...
                <!-- Item -->
                <li class="port-item mix design lightbox-item">
                  <a href="<?= base_url().'assets/'?>images/programs_vtp/5big.jpg" class="lightbox">
                    <div class="port-img-overlay">
                      <img class="port-main-img" src="<?= base_url().'assets/'?>images/programs_vtp/5.jpg" alt="img" >
                    </div>
                    <div class="port-overlay-cont">
                      <div class="port-btn-cont">
                        <div aria-hidden="true" class="icon_search"></div>
                ...
                <!-- Item -->
                <li class="port-item mix design lightbox-item">
                  <a href="<?= base_url().'assets/'?>images/programs_vtp/4big.jpg" class="lightbox">
                    <div class="port-img-overlay">
                      <img class="port-main-img" src="<?= base_url().'assets/'?>images/programs_vtp/4.jpg" alt="img" >
                    </div>
                    <div class="port-overlay-cont">
                      <div class="port-btn-cont">
                        <div aria-hidden="true" class="icon_search"></div>
                ...
                <!-- Item -->
                <li class="port-item mix design lightbox-item">
                  <a href="<?= base_url().'assets/'?>images/programs_vtp/6big.jpg" class="lightbox">
                    <div class="port-img-overlay">
                      <img class="port-main-img" src="<?= base_url().'assets/'?>images/programs_vtp/6.jpg" alt="img" >
                    </div>
                    <div class="port-overlay-cont">
                      <div class="port-btn-cont">
                        <div aria-hidden="true" class="icon_search"></div>
