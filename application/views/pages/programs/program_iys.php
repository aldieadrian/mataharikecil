...
<html>
 	<head>
		<title>Programs - Indonesia Youth Sociopreneur</title>
		<meta charset="utf-8">
		<!--[if IE]><meta http-equiv='X-UA-Compatible' content='IE=edge,chrome=1'><![endif]-->
		<meta name="robots" content="index, follow" > 
		<meta name="keywords" content="Mataharikecil" > 
		<meta name="description" content="Programs - Indonesia Youth Sociopreneur" > 
        ...
        <div class="page-title-large5-cont bg-gray-dark">
          <div class="container relative">
         	  <div class="page-title-large5-text-cont">
         	  	<div>
         	  	  <h1 class="page-title5"><font color="white">Indonesia Youth Sociopreneur</font></h1>
         	  	</div>
         	  </div>
          </div>
        </div>
            ...
            <div class="post-prev-img mb-50">
              <img src="<?= base_url().'assets/'?>images/programs_iys/header.jpg" alt="img"></a>
            </div>
            ...
            <div class="row">
              ...
              <!-- TEXT -->
                ...
                <h4 class="font-open-sans"><strong>Indonesia Youth Sociopreneur</strong></h4>
                <p>Indonesia Youth Sociopreneur merupakan program dari Mataharikecil Indonesia Foundation dimana kami mengumpulkan pemuda terbaik bangsa guna untuk meningkatkan ekonomi keluarga anak didik kami melalui sociopreneurship program.</p>
                <p>Dalam program ini kalian akan bekerja sebagai team dan mendapat capacity building melalui on the job training program dimana kalian akan turun langsung membantu meningkatakan perekonomian orang tua siswa di Mataharikecil melalui sociopreneur program.</p>
                <p>Dan yang gakalah penting kalian juga akan mendapat training dari berbagai expert, keluarga baru bahkan kalian akan mendapat international exposure mengenai sociopreneur.</p>
							</div>
            ...
            <!-- ITEMS GRID -->
              <ul class="port-grid masonry clearfix" id="items-grid">
                ...
                <li class="port-item mix design lightbox-item">
                  <a href="<?= base_url().'assets/'?>images/programs_iys/1.jpg" class="lightbox">
                    <div class="port-img-overlay">
                      <img class="port-main-img" src="<?= base_url().'assets/'?>images/programs_iys/1.jpg" alt="img" >
                    </div>
                ...
                <!-- Item -->
                <li class="port-item mix design lightbox-item">
                  <a href="<?= base_url().'assets/'?>images/programs_iys/3big.jpg" class="lightbox">
                    <div class="port-img-overlay">
                      <img class="port-main-img" src="<?= base_url().'assets/'?>images/programs_iys/3.jpg" alt="img" >
                    </div>
                    <div class="port-overlay-cont">
                      <div class="port-btn-cont">
                        <div aria-hidden="true" class="icon_search"></div>
                ...
                <!-- Item big -->
                <li class="port-item mix design lightbox-item">
                  <a href="<?= base_url().'assets/'?>images/programs_iys/2.jpg" class="lightbox">
                    <div class="port-img-overlay">
                      <img class="port-main-img" src="<?= base_url().'assets/'?>images/programs_iys/2.jpg" alt="img" >
                    </div>
                    <div class="port-overlay-cont">
                      <div class="port-btn-cont">
                        <div aria-hidden="true" class="icon_search"></div>
                ...
                <!-- Item -->
                <li class="port-item mix design lightbox-item">
                  <a href="<?= base_url().'assets/'?>images/programs_iys/4big.jpg" class="lightbox">
                    <div class="port-img-overlay">
                      <img class="port-main-img" src="<?= base_url().'assets/'?>images/programs_iys/4.jpg" alt="img" >
                    </div>
                    <div class="port-overlay-cont">
                      <div class="port-btn-cont">
                        <div aria-hidden="true" class="icon_search"></div>
                ...
                <!-- Item -->
                <li class="port-item mix design lightbox-item">
                  <a href="<?= base_url().'assets/'?>images/programs_iys/5big.jpg" class="lightbox">
                    <div class="port-img-overlay">
                      <img class="port-main-img" src="<?= base_url().'assets/'?>images/programs_iys/5.jpg" alt="img" >
                    </div>
                    <div class="port-overlay-cont">
                      <div class="port-btn-cont">
                        <div aria-hidden="true" class="icon_search"></div>
                ...
                <!-- Item -->
                <li class="port-item mix design lightbox-item">
                  <a href="<?= base_url().'assets/'?>images/programs_iys/6big.jpg" class="lightbox">
                    <div class="port-img-overlay">
                      <img class="port-main-img" src="<?= base_url().'assets/'?>images/programs_iys/6.jpg" alt="img" >
                    </div>
                    <div class="port-overlay-cont">
                      <div class="port-btn-cont">
                        <div aria-hidden="true" class="icon_search"></div>
