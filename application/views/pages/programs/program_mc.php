...
<html>
 	<head>
		<title>Programs - Mataharikecil Community</title>
		<meta charset="utf-8">
		<!--[if IE]><meta http-equiv='X-UA-Compatible' content='IE=edge,chrome=1'><![endif]-->
		<meta name="robots" content="index, follow" > 
		<meta name="keywords" content="Mataharikecil" > 
		<meta name="description" content="Programs - Mataharikecil Community" > 
        ...
        <div class="page-title-large5-cont bg-gray-dark">
          <div class="container relative">
         	  <div class="page-title-large5-text-cont">
         	  	<div>
         	  	  <h1 class="page-title5"><font color="white">Mataharikecil Community</font></h1>
         	  	</div>
         	  </div>
          </div>
        </div>
            ...
            <div class="post-prev-img mb-50">
              <img src="<?= base_url().'assets/'?>images/about_foundation/header.jpg" alt="img"></a>
            </div>
            ...
            <div class="row">
              ...
              <!-- TEXT -->
                ...
                <h4 class="font-gotham"><strong>Mataharikecil Community</strong></h4>
                <p>Mataharikecil Community adalah wadah bagi generasi muda untuk berbagi, berkolaborasi dan berkontribusi dalam bidang pendidikan. Mataharikecil Community menginisiasi kegiatan edukasi yang sejalan dengan visi misi Mataharikecil Indonesia Foundation.</p>
							</div>
            ...
            <!-- ITEMS GRID -->
              <ul class="port-grid masonry clearfix" id="items-grid">
                ...
                <li class="port-item mix design lightbox-item">
                  <a href="<?= base_url().'assets/'?>images/programs_mc/1.jpg" class="lightbox">
                    <div class="port-img-overlay">
                      <img class="port-main-img" src="<?= base_url().'assets/'?>images/programs_mc/1.jpg" alt="img" >
                    </div>
                ...
                <!-- Item -->
                <li class="port-item mix design lightbox-item">
                  <a href="<?= base_url().'assets/'?>images/programs_mc/3big.jpg" class="lightbox">
                    <div class="port-img-overlay">
                      <img class="port-main-img" src="<?= base_url().'assets/'?>images/programs_mc/3.jpg" alt="img" >
                    </div>
                    <div class="port-overlay-cont">
                      <div class="port-btn-cont">
                        <div aria-hidden="true" class="icon_search"></div>
                ...
                <!-- Item big -->
                <li class="port-item mix design lightbox-item">
                  <a href="<?= base_url().'assets/'?>images/programs_mc/2.jpg" class="lightbox">
                    <div class="port-img-overlay">
                      <img class="port-main-img" src="<?= base_url().'assets/'?>images/programs_mc/2.jpg" alt="img" >
                    </div>
                    <div class="port-overlay-cont">
                      <div class="port-btn-cont">
                        <div aria-hidden="true" class="icon_search"></div>
                ...
                <!-- Item -->
                <li class="port-item mix design lightbox-item">
                  <a href="<?= base_url().'assets/'?>images/programs_mc/4big.jpg" class="lightbox">
                    <div class="port-img-overlay">
                      <img class="port-main-img" src="<?= base_url().'assets/'?>images/programs_mc/4.jpg" alt="img" >
                    </div>
                    <div class="port-overlay-cont">
                      <div class="port-btn-cont">
                        <div aria-hidden="true" class="icon_search"></div>
                ...
                <!-- Item -->
                <li class="port-item mix design lightbox-item">
                  <a href="<?= base_url().'assets/'?>images/programs_mc/5big.jpg" class="lightbox">
                    <div class="port-img-overlay">
                      <img class="port-main-img" src="<?= base_url().'assets/'?>images/programs_mc/5.jpg" alt="img" >
                    </div>
                    <div class="port-overlay-cont">
                      <div class="port-btn-cont">
                        <div aria-hidden="true" class="icon_search"></div>
                ...
                <!-- Item -->
                <li class="port-item mix design lightbox-item">
                  <a href="<?= base_url().'assets/'?>images/programs_mc/6big.jpg" class="lightbox">
                    <div class="port-img-overlay">
                      <img class="port-main-img" src="<?= base_url().'assets/'?>images/programs_mc/6.jpg" alt="img" >
                    </div>
                    <div class="port-overlay-cont">
                      <div class="port-btn-cont">
                        <div aria-hidden="true" class="icon_search"></div>
