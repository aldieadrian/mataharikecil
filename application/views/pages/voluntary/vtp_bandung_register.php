...
<html>
 	<head>
		<title>Voluntary - Bandung</title>
		<meta charset="utf-8">
		<!--[if IE]><meta http-equiv='X-UA-Compatible' content='IE=edge,chrome=1'><![endif]-->
		<meta name="robots" content="index, follow" > 
		<meta name="keywords" content="Mataharikecil" > 
		<meta name="description" content="Voluntary - Bandung" > 
        ...
        <div class="page-title-large5-cont bg-gray-dark">
          <div class="container relative">
         	  <div class="page-title-large5-text-cont">
         	  	<div>
         	  	  <h1 class="page-title5"><font color="white">VTP Bandung Batch 12</font></h1>
         	  	</div>
         	  </div>
          </div>
        </div>
            ...
            <div class="post-prev-img mb-50">
              <img src="<?= base_url().'assets/'?>images/programs_vtp/header_vtp_bandung.jpg" alt="img"></a>
            </div>
            ...
            <div class="row">
              ...
              <!-- TEXT -->
                ...
                <h4 class="font-open-sans"><strong>Voluntary Teaching Program Bandung</strong></h4>
                <p>Dear Bandung people, <br>Open Recruitment untuk Voluntary Teaching Batch 12 sudah dibuka, den periode mengajar 30 September 2019 sampai 29 Febuari 2020. Volunteer Teaching Program Mataharikecil Bandung membantu mengembangkan SMP-TERBUKA yang berada di Masjid Nurul Hidayah (SMP Terbuka TKB Firdaus).<br>Alamat: Jl. Paralayang No.2, Cisaranten Endah, Arcamanik Kota Bandung, Jawa Barat. 40293.</p>
                <p>Untuk kalian yang tertarik memabantu siswa-siswi kami, harap daftarkan diri dengan cara klik tombol di bawah. Pendaftaran ditutup pada tanggal 17 September 2019.<br>Para generasi penerus bangsa, kami tunggu parisipasinya ya!</p>
							</div>
              
						</div>

             <div class="fes12-btn-cont mt-30">
                <a class="button medium rounded gray" href="https://docs.google.com/forms/d/e/1FAIpQLSfak_epvjc1t63JS8zLaqc8vECgg0uemYbXjF4HgKStmzo5UA/viewform" target="_blank">Daftar Volunteer</a>
              </div>
