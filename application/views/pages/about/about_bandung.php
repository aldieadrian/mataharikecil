...
<html>
 	<head>
		<title>About - Mataharikecil Bandung</title>
		<meta charset="utf-8">
		<!--[if IE]><meta http-equiv='X-UA-Compatible' content='IE=edge,chrome=1'><![endif]-->
		<meta name="robots" content="index, follow" > 
		<meta name="keywords" content="Mataharikecil" > 
		<meta name="description" content="About - Mataharikecil Bandung" > 
        ...
        <div class="page-title-large5-cont bg-gray-dark">
          <div class="container relative">
         	  <div class="page-title-large5-text-cont">
         	  	<div>
         	  	  <h1 class="page-title5"><font color="white">Mataharikecil Bandung</font></h1>
         	  	</div>
         	  </div>
          </div>
        </div>
            ...
            <div class="post-prev-img mb-50">
              <img src="<?= base_url().'assets/'?>images/about_bandung/header.jpg" alt="img"></a>
            </div>
            ...
            <div class="row">
              ...
              <!-- TEXT -->
                ...
                <h4 class="font-open-sans"><strong>Mataharikecil Bandung</strong></h4>
                <p>Mataharikecil Bandung memiliki program utama untuk membantu dan meringankan beban baik pendidikan, ekonomi maupun sosial dari anak-anak SMP Terbuka Firdaus secara berkelanjutan, salah satunya dengan memfasilitasi sekolah gratis tanpa pungutan biaya. Seluruh biaya sekolah anak-anak seperti seragam, alat tulis, buku dan sebagainya didanai oleh divisi Sociopreneur Mataharikecil Indonesia Foundation dan donatur.</p>
                <p>Mataharikecil Bandung juga menyediakan atau merekrut pengajar sukarela untuk anak-anak SMP Terbuka Firdaus dari berbagai kalangan anak muda yaitu pelajar atau mahasiswa dan pekerja yang memiliki waktu luang di Kota Bandung dalam Voluntary Teaching Program.</p>
							</div>
            ...
            <!-- ITEMS GRID -->
              <ul class="port-grid masonry clearfix" id="items-grid">
                ...
                <li class="port-item mix design lightbox-item">
                  <a href="<?= base_url().'assets/'?>images/about_bandung/1.jpg" class="lightbox">
                    <div class="port-img-overlay">
                      <img class="port-main-img" src="<?= base_url().'assets/'?>images/about_bandung/1.jpg" alt="img" >
                    </div>
                ...
                <!-- Item -->
                <li class="port-item mix design lightbox-item">
                  <a href="<?= base_url().'assets/'?>images/about_bandung/3big.jpg" class="lightbox">
                    <div class="port-img-overlay">
                      <img class="port-main-img" src="<?= base_url().'assets/'?>images/about_bandung/3.jpg" alt="img" >
                    </div>
                    <div class="port-overlay-cont">
                      <div class="port-btn-cont">
                        <div aria-hidden="true" class="icon_search"></div>
                ...
                <!-- Item big -->
                <li class="port-item mix design lightbox-item">
                  <a href="<?= base_url().'assets/'?>images/about_bandung/2.jpg" class="lightbox">
                    <div class="port-img-overlay">
                      <img class="port-main-img" src="<?= base_url().'assets/'?>images/about_bandung/2.jpg" alt="img" >
                    </div>
                    <div class="port-overlay-cont">
                      <div class="port-btn-cont">
                        <div aria-hidden="true" class="icon_search"></div>
                ...
                <!-- Item -->
                <li class="port-item mix design lightbox-item">
                  <a href="<?= base_url().'assets/'?>images/about_bandung/4big.jpg" class="lightbox">
                    <div class="port-img-overlay">
                      <img class="port-main-img" src="<?= base_url().'assets/'?>images/about_bandung/4.jpg" alt="img" >
                    </div>
                    <div class="port-overlay-cont">
                      <div class="port-btn-cont">
                        <div aria-hidden="true" class="icon_search"></div>
                ...
                <!-- Item -->
                <li class="port-item mix design lightbox-item">
                  <a href="<?= base_url().'assets/'?>images/about_bandung/5big.jpg" class="lightbox">
                    <div class="port-img-overlay">
                      <img class="port-main-img" src="<?= base_url().'assets/'?>images/about_bandung/5.jpg" alt="img" >
                    </div>
                    <div class="port-overlay-cont">
                      <div class="port-btn-cont">
                        <div aria-hidden="true" class="icon_search"></div>
                ...
                <!-- Item -->
                <li class="port-item mix design lightbox-item">
                  <a href="<?= base_url().'assets/'?>images/about_bandung/6big.jpg" class="lightbox">
                    <div class="port-img-overlay">
                      <img class="port-main-img" src="<?= base_url().'assets/'?>images/about_bandung/6.jpg" alt="img" >
                    </div>
                    <div class="port-overlay-cont">
                      <div class="port-btn-cont">
                        <div aria-hidden="true" class="icon_search"></div>
