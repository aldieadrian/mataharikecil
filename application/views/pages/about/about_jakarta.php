...
<html>
 	<head>
		<title>About - Mataharikecil Jakarta</title>
		<meta charset="utf-8">
		<!--[if IE]><meta http-equiv='X-UA-Compatible' content='IE=edge,chrome=1'><![endif]-->
		<meta name="robots" content="index, follow" > 
		<meta name="keywords" content="Mataharikecil" > 
		<meta name="description" content="About - Mataharikecil Jakarta" > 
...
<!-- CSS -->
    ...
    <!-- IE Warning CSS -->
		<!--[if lte IE 8]><link rel="stylesheet" type="text/css" href="<?= base_url().'assets/'?>css/ie-warning.css" ><![endif]-->
		<!--[if lte IE 8]><link rel="stylesheet" type="text/css" href="<?= base_url().'assets/'?>css/ie8-fix.css" ><![endif]-->
...
<!-- JS begin some js files in bottom of file-->
    ...
    <div id="loader-overflow">
        ...
        <div class="page-title-large5-cont bg-gray-dark">
          <div class="container relative">
         	  <div class="page-title-large5-text-cont">
         	  	<div>
         	  	  <h1 class="page-title5"><font color="white">Mataharikecil Jakarta</font></h1>
         	  	</div>
         	  </div>
          </div>
        </div>
            ...
            <div class="post-prev-img mb-50">
              <img src="<?= base_url().'assets/'?>images/about_jakarta/header.jpg" alt="img"></a>
            </div>
            ...
            <div class="row">
              ...
              <!-- TEXT -->
                ...
                <h4 class="font-open-sans"><strong>Mataharikecil Jakarta</strong></h4>
                <p>Mataharilkecil Jakarta menyediakan bantuan untuk TK Warga Teladan berupa sistem, program, dan sumber daya secara sukarela bagi pelajar/mahasiswa dan pekerja di Kota Jakarta sejak tahun 2017.</p>
                <p>Sebagian siswa TK ini merupakan siswa yang memiliki kondisi ekonomi kurang mampu, semua kebutuhan siswa tersebut didanai oleh Mataharikecil Indonesia Foundation dan donatur.</p>
                <p>TK warga teladan di didirkan pada tahun 1971 , terletak di jalan kebon kacang 13, Tanah abang, Jakarta Pusat. TK yang dahulu merupakan salah satu TK terbaik di kebon kacang, memiliki siswa lebih dari 100, prestasi yang melimpah, sistem yang baik dan sebagainya, namun hal tersebut menurun dengan seiring berjalan nya waktu, sampai akhirnya pada tahun 2016, Yasser berniat membantu TK tersebut, sampai akhirnya dibuatlah mataharikecil cabang jakarta yang kini membantu TK warga Teladan kebon kacang dari sisi 3 hal :</p>
                <ol>
                  <li>Perbaikan sistem sekolah (pengajaran, administrasi, jadwal, dll)</li>
                  <li>Fasilitas (bangunan, mainan anak dll)</li>
                  <li>Sumber daya Manusia (pelatihan guru & volunteer, mengikut sertakan masyarakat)</li>
                </ol>
							</div>
            ...
            <!-- ITEMS GRID -->
              <ul class="port-grid masonry clearfix" id="items-grid">
                ...
                <li class="port-item mix design lightbox-item">
                  <a href="<?= base_url().'assets/'?>images/about_jakarta/1.jpg" class="lightbox">
                    <div class="port-img-overlay">
                      <img class="port-main-img" src="<?= base_url().'assets/'?>images/about_jakarta/1.jpg" alt="img" >
                    </div>
                ...
                <!-- Item -->
                <li class="port-item mix design lightbox-item">
                  <a href="<?= base_url().'assets/'?>images/about_jakarta/3big.jpg" class="lightbox">
                    <div class="port-img-overlay">
                      <img class="port-main-img" src="<?= base_url().'assets/'?>images/about_jakarta/3.jpg" alt="img" >
                    </div>
                    <div class="port-overlay-cont">
                      <div class="port-btn-cont">
                        <div aria-hidden="true" class="icon_search"></div>
                ...
                <!-- Item big -->
                <li class="port-item mix design lightbox-item">
                  <a href="<?= base_url().'assets/'?>images/about_jakarta/2.jpg" class="lightbox">
                    <div class="port-img-overlay">
                      <img class="port-main-img" src="<?= base_url().'assets/'?>images/about_jakarta/2.jpg" alt="img" >
                    </div>
                    <div class="port-overlay-cont">
                      <div class="port-btn-cont">
                        <div aria-hidden="true" class="icon_search"></div>
                ...
                <!-- Item -->
                <li class="port-item mix design lightbox-item">
                  <a href="<?= base_url().'assets/'?>images/about_jakarta/5big.jpg" class="lightbox">
                    <div class="port-img-overlay">
                      <img class="port-main-img" src="<?= base_url().'assets/'?>images/about_jakarta/5.jpg" alt="img" >
                    </div>
                    <div class="port-overlay-cont">
                      <div class="port-btn-cont">
                        <div aria-hidden="true" class="icon_search"></div>
                ...
                <!-- Item -->
                <li class="port-item mix design lightbox-item">
                  <a href="<?= base_url().'assets/'?>images/about_jakarta/4big.jpg" class="lightbox">
                    <div class="port-img-overlay">
                      <img class="port-main-img" src="<?= base_url().'assets/'?>images/about_jakarta/4.jpg" alt="img" >
                    </div>
                    <div class="port-overlay-cont">
                      <div class="port-btn-cont">
                        <div aria-hidden="true" class="icon_search"></div>
                ...
                <!-- Item -->
                <li class="port-item mix design lightbox-item">
                  <a href="<?= base_url().'assets/'?>images/about_jakarta/6big.jpg" class="lightbox">
                    <div class="port-img-overlay">
                      <img class="port-main-img" src="<?= base_url().'assets/'?>images/about_jakarta/6.jpg" alt="img" >
                    </div>
                    <div class="port-overlay-cont">
                      <div class="port-btn-cont">
                        <div aria-hidden="true" class="icon_search"></div>
