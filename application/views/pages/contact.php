...
<html>
 	<head>
		<title>Contact - Mataharikecil</title>
		<meta charset="utf-8">
		<!--[if IE]><meta http-equiv='X-UA-Compatible' content='IE=edge,chrome=1'><![endif]-->
		<meta name="robots" content="index, follow" > 
		<meta name="keywords" content="Mataharikecil" > 
		<meta name="description" content="Contact - Mataharikecil Indonesia Foundation" > 
        ...
        <div class="page-title-large5-cont bg-gray-dark">
          <div class="container relative">
            <div class="page-title-large5-text-cont">
              <div>
                <h1 class="page-title5"><font color="white">Contact</font></h1>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="page-section">
          <div class="container-fluid">
            <div class="row row-sm-fix">
              <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3960.7276703411003!2d107.66989941431713!3d-6.923122469685354!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e68dd5455b22e7d%3A0x424ed11f928f271c!2sSMP%20Terbuka%20Firdaus!5e0!3m2!1sid!2sid!4v1567293271903!5m2!1sid!2sid" width="1349" height="450" frameborder="0" style="border:0;" allowfullscreen=""></iframe>
            </div>
          </div>
        </div>
            ...
            <div class="row">
              ...
              <div class="col-md-4 col-sm-6">
                <div class="cis-cont">
                  ...
                  <div class="cis-text">
                    <h3>Address</h3>
                    <p>SMP Terbuka Firdaus Kota Bandung, 40293<br>
                  </div>
                </div>
              </div>
              <div class="col-md-4 col-sm-6">
                <div class="cis-cont">
                  ...
                  <div class="cis-text">
                    <h3>Email</h3>
                    <p><a class="a-text" href="mailto:mataharikecil.id@gmail.com">mataharikecil.id@gmail.com</a></p>
                  </div>
                </div>
              </div>
              <div class="col-md-4 col-sm-6">
...
<!-- JS begin -->
    ...
    <!-- FORMS VALIDATION	-->
		...
		<script src="<?= base_url().'assets/'?>js/contact-form-validation.min.js"></script>
